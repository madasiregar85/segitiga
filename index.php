...
<body>
  ...
  <form id="login_form" action="index.php" method="post">
    <div class="field_container">
        <img src="http://1.bp.blogspot.com/_wpqftFCqYKs/TOjC1AIenyI/AAAAAAAAAAY/shpi8J4bd6U/S980-R/BANNER%2Bcopy.jpg">
        <br>
    ...
    <div class="field_container">
      ...
      <button id="sign_in_button" type="submit" name="submit" value ="hitung">
        <span class="button_text">hitung</span>
      </button>
    </div>
